...
<div class="maincont">
 ...
 <form action="" method="post" onsubmit="return false;" class="reg-login">
  <div class="lrBox">
   <input type="hidden" name="address_id" value="{{$updateInfo->address_id}}" id="address_id">
   <div class="lrList"><input type="text" value="{{$updateInfo->address_name}}" name="address_name" id="address_name" placeholder="收货人" /></div>
   <div class="lrList"><input type="text" value="{{$updateInfo->address_mail}}" name="address_mail" id="address_mail" placeholder="邮编" /></div>
   <select name="province" class="ads" id="province">
    <option selected value="">省份/直辖市/自治区</option>
    @foreach($province as $k=>$v)
      @if($updateInfo->province == $v->id)
       <option style="color:black;" value="{{$v->id}}" selected>{{$v->name}}</option>
      @else
   ...
   <div class="lrList"><input type="text" value="{{$updateInfo->address_add}}" name="address_add" id="address_add" placeholder="详细地址" /></div>
   <div class="lrList"><input type="text" value="{{$updateInfo->address_tel}}" name="address_tel" id="address_tel" placeholder="手机号" /></div>
